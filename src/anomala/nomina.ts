...
export default class Nomina extends Anomala<Nomen> {
  ...
  protected override async numeretur (): Promise<void> {
    ...
    const balneum: Ignavum<TabulaBifissa> = new Ignavum(() => new TabulaBifissa({
    ...
    const caelum: Ignavum<TabulaBifissa> = new Ignavum(() => new TabulaBifissa({
      singularis: new Structor(() => new NomenAgendum)
    ...
    const dea: Ignavum<TabulaCollata<Nomen>> = new Ignavum(() => new TabulaCollata(
      new Ignavum(() =>
    ...
    const domus: Ignavum<TabulaCollata<Nomen>> = new Ignavum(() => new TabulaCollata(
      new Ignavum(() => new TabulaScapalis({
        via: '/res/scapales/nomina/domus',
        positor: Nomen.positor
      })),
      new Ignavum(() => new Structor(() =>
        new NomenAgendum)
    ...
    const iugerum: Ignavum<TabulaCollata<Nomen>> = new Ignavum(() => new TabulaCollata(
      new Ignavum(() => new TabulaScapalis({
