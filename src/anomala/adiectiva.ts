...
export default class Adiectiva extends Anomala<Adiectivum> {
  ...
  protected override async numeretur (): Promise<void> {
    ...
    const decimum: Ignavum<Incomparabile> = new Ignavum(() => new Structor(() => new Incomparabile)
    ...
    const utrum: Ignavum<Incomparabile> = new Ignavum(() => new Structor(() => new Incomparabile)
    ...
    const aliud: Ignavum<TabulaCollata<Adiectivum>> = new Ignavum(() =>
      new TabulaCollata(
        new Ignavum(() =>
          new TabulaScapalis({ via: '/res/scapales/adiectiva/aliud', positor: Adiectivum.positor })),
        new Ignavum(() => new Structor(() => new Incomparabile)
    ...
    const ambo: Ignavum<TabulaCollata<Adiectivum>> = new Ignavum(() =>
      new TabulaCollata(
        new Ignavum(() =>
          new TabulaScapalis({ via: '/res/scapales/adiectiva/ambō', positor: Adiectivum.positor })),
        new Ignavum(() => new Structor(() => new Incomparabile)
    ...
    const meum: Ignavum<TabulaCollata<Adiectivum>> = new Ignavum(() =>
      new TabulaCollata(
        new Ignavum(() =>
          new TabulaScapalis({ via: '/res/scapales/adiectiva/meum', positor: Adiectivum.positor })),
        new Ignavum(() => new Structor(() => new Incomparabile)
    ...
    const multum: Ignavum<TabulaCollata<Adiectivum>> = new Ignavum(() =>
      new TabulaCollata(
        new Ignavum(() =>
          new TabulaScapalis({ via: '/res/scapales/adiectiva/multum', positor: Adiectivum.positor })),
        new Ignavum(() => new Structor(() => new AdiectivumAgendum)
    ...
    const nonumdecimum: Ignavum<TabulaConiuncta<Adiectivum>> = new Ignavum(() =>
      new TabulaConiuncta({
        ...
        prima: new Ignavum(() => new Structor(() => new Incomparabile)
